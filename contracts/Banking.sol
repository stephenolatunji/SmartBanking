...
contract Banking {
    ...
    //Function to create account , the 1 ETH balance will be taken from your ethereum account and deposited to the banking contract
    function createAccount(
        address payable _creator,
        string memory _name,
        string memory _location
    ) public payable {
        if (_creator.balance >= 1) {
            serialNumber++;
            ...
            // revert InsufficientFunds(serialNumber,1,_creator.balance-1,'NewAccount');
        }
    }
